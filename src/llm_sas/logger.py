"""llm_sas logging configuration.

This module uses structlog, a third-party library that enables
straightforward and flexibilible structured logging in Python.
